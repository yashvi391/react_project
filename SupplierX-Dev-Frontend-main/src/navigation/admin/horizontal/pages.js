        ...
        children: [
          {
            id: 'welcomeTemp',
            title: 'Welcome',
            navLink: 'https://SupplierX.com/demo/SupplierX-mail-template/mail-welcome.html',
            externalLink: true
          },
          {
            id: 'resetPassTemp',
            title: 'Reset Password',
            navLink: 'https://SupplierX.com/demo/SupplierX-mail-template/mail-reset-password.html',
            externalLink: true
          },
          {
            id: 'verifyEmailTemp',
            title: 'Verify Email',
            navLink: 'https://SupplierX.com/demo/SupplierX-mail-template/mail-verify-email.html',
            externalLink: true
          },
          {
            id: 'deactivateAccountTemp',
            title: 'Deactivate Account',
            navLink: 'https://SupplierX.com/demo/SupplierX-mail-template/mail-deactivate-account.html',
            externalLink: true
          },
          {
            id: 'invoiceMailTemp',
            title: 'Invoice',
            navLink: 'https://SupplierX.com/demo/SupplierX-mail-template/mail-invoice.html',
            externalLink: true
          },
          {
            id: 'promotionalMailTemp',
            title: 'Promotional',
            navLink: 'https://SupplierX.com/demo/SupplierX-mail-template/mail-promotional.html',
            externalLink: true
          }
        ]
      },
