...
const storageLocation = () => {
  ...
  const request = (reset_offset = true) => {
    ...
    axios
      .post(
        new URL(
          "/api/v1/supplier/storageLocation/list",
    ...
    MySwal.fire({
      ...
      if (result.value) {
        axios
          .delete(
            new URL(
              `/api/v1/supplier/storageLocation/delete/${row.id}`,
              themeConfig.backendUrl
            )
          )
          .then((response) => {
  ...
  const AddModal = () => {
    ...
    const onSubmit = (e) => {
      ...
      axios
        .post(
          new URL(
            "/api/v1/supplier/storageLocation/create",
            themeConfig.backendUrl
          ),
          form
        )
  ...
  const EditModal = () => {
    ...
    const onSubmitEdit = (e) => {
      ...
      axios
        .put(
          new URL(
            "/api/v1/supplier/storageLocation/update",
            themeConfig.backendUrl
          ),
          form
        )
