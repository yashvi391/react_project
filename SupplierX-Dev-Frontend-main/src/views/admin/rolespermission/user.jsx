...
const User = () => {
  ...
  const request = (reset_offset = true) => {
    ...
    axios
      .post(new URL("/api/admin/users/list", themeConfig.backendUrl), query)
      .then((res) => {
        if (res.data.error) {
  ...
  const AddModal = () => {
    ...
    const onSubmit = (e) => {
      e.preventDefault();
      axios
        .post(new URL("/api/admin/users/create", themeConfig.backendUrl), {
          ...form,
  ...
  const EditModal = () => {
    ...
    const onSubmitEdit = (e) => {
      ...
      axios
        .put(new URL("/api/admin/users/update", themeConfig.backendUrl), {
          ...form,
          role: selectedOption.value,
        })
        .then((res) => {
