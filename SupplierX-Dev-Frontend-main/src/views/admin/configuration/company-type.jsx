...
const CompanyType = () => {
  ...
  const request = (reset_offset = true) => {
    ...
    axios
      .post(
        new URL("/api/v1/admin/companyType/type/get", themeConfig.backendUrl),
        query
      )
      .then((res) => {
        if (res.data.error) {
    ...
    MySwal.fire({
      ...
      if (result.value) {
        axios
          .delete(
            new URL(
              `/api/v1/admin/companyType/type/delete/${row.id}`,
  ...
  const AddModal = () => {
    ...
    const onSubmit = (e) => {
      ...
      axios
        .post(
          new URL(
            "/api/v1/admin/companyType/type/create",
            themeConfig.backendUrl
          ),
          form
        )
                ...
                <div className="col-md-12 me-1 mt-1">
                  <div className="form-group">
                    ...
                    <input
                      ...
                      placeholder="Eg. Public Limited Companies"
                      required
                    />
                  </div>
                </div>
  ...
  const EditModal = () => {
    ...
    const onSubmitEdit = (e) => {
      ...
      axios
        .post(
          new URL(
            "/api/v1/admin/companyType/type/update",
            themeConfig.backendUrl
          ),
          form
        )
