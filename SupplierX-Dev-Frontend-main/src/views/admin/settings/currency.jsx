...
const currency = () => {
  ...
  const request = (reset_offset = true) => {
    ...
    axios
      .post(
        new URL("/api/v1/admin/currency/get", themeConfig.backendUrl),
        query
      )
      .then((res) => {
        if (res.data.error) {
    ...
    MySwal.fire({
      ...
      if (result.value) {
        axios
          .delete(
            new URL(
              `/api/v1/admin/currency/delete/${row.id}`,
  ...
  const AddModal = () => {
    ...
    const onSubmit = (e) => {
      ...
      axios
        .post(
          new URL("/api/v1/admin/currency/create", themeConfig.backendUrl),
          form
        )
        .then((res) => {
          if (res.data.error) {
  ...
  const EditModal = () => {
    ...
    const onSubmitEdit = (e) => {
      ...
      axios
        .post(
          new URL("/api/v1/admin/currency/update", themeConfig.backendUrl),
          form
        )
        .then((res) => {
          if (res.data.error) {
