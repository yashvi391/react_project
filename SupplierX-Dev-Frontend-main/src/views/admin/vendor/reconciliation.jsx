...
const Reconciliation = () => {
  ...
  const request = (reset_offset = true) => {
    ...
    axios
      .post(
        new URL("/api/v1/admin/reconciliation/list", themeConfig.backendUrl),
        query
      )
      .then((res) => {
        if (res.data.error) {
    ...
    MySwal.fire({
      ...
      if (result.value) {
        axios
          .delete(
            new URL(
              `/api/admin/reconciliation/delete/${row.id}`,
  ...
  useEffect(() => {
    request();
    axios
      .post(new URL("/api/v1/admin/materialGroup/list", themeConfig.backendUrl))
      .then((response) => {
  ...
  const AddModal = () => {
    ...
    const onSubmit = (e) => {
      ...
      axios
        .post(
          new URL(
            "/api/v1/admin/reconciliation/create",
            themeConfig.backendUrl
          ),
          {
            ...form,
  ...
  const EditModal = () => {
    ...
    const onSubmitEdit = (e) => {
      ...
      axios
        .put(
          new URL(
            "/api/v1/admin/reconciliation/update",
            themeConfig.backendUrl
          ),
          form
        )
