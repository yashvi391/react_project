...
const CalSchema = () => {
  ...
  const request = (reset_offset = true) => {
    ...
    axios
      .post(
        new URL(
          "/api/v1/configuration/group_of_calculation_schema/list",
    ...
    MySwal.fire({
      ...
      if (result.value) {
        axios
          .delete(
            new URL(
              `/api/v1/configuration/group_of_calculation_schema/delete/${row.id}`,
              themeConfig.backendUrl
            )
          )
          .then((response) => {
  ...
  const AddModal = () => {
    ...
    const onSubmit = (e) => {
      ...
      axios
        .post(
          new URL(
            "/api/v1/configuration/group_of_calculation_schema/create",
            themeConfig.backendUrl
          ),
          form
        )
  ...
  const EditModal = () => {
    ...
    const onSubmitEdit = (e) => {
      ...
      axios
        .put(
          new URL(
            "/api/v1/configuration/group_of_calculation_schema/update",
            themeConfig.backendUrl
          ),
          form
        )
      ...
      <div className="card">
        ...
        <div className="card-body">
          <div className="d-flex justify-content-between align-center">
            <h4>Group of Calculation Schema</h4>
            <Button
              color="primary"
              size="sm"
