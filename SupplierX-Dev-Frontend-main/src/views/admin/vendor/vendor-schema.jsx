...
const BusinessGroup = () => {
  ...
  const request = (reset_offset = true) => {
    ...
    axios
      .post(
        new URL("/api/v1/admin/vendorSchema/list", themeConfig.backendUrl),
        query
      )
      .then((res) => {
        if (res.data.error) {
    ...
    MySwal.fire({
      ...
      if (result.value) {
        axios
          .delete(
            new URL(
              `/api/v1/admin/vendorSchema/delete/${row.id}`,
  ...
  const AddModal = () => {
    ...
    const onSubmit = (e) => {
      ...
      //     form_data.append(val, form[val])
      // })
      // form_data.append("product_id", id)
      axios
        .post(
          new URL("/api/v1/admin/vendorSchema/create", themeConfig.backendUrl),
          form
        )
        .then((res) => {
          if (res.data.error) {
              ...
              <div className="row">
                <div className="col-md-12 me-1 mt-1">
                  <div className="form-group">
                    <label>Vendor Schema Code</label>
                    <input
                      type="text"
                      name="code"
                      value={form.code}
                      ...
                      placeholder="Vendor Schema Code"
                      required
                    />
                  </div>
                </div>
  ...
  const EditModal = () => {
    ...
    const onSubmitEdit = (e) => {
      ...
      axios
        .put(
          new URL("/api/v1/admin/vendorSchema/update", themeConfig.backendUrl),
          form
        )
        .then((res) => {
          if (res.data.error) {
            ...
            <ModalBody>
              <div className="row">
                {/* <div className="col-md-12 me-1 mt-1">
                                    <div className="form-group">
                                        <label>Id</label>
                                        <input type="text" name="id" value={form.id} onChange={e => {
                                            setForm({ ...form, id: e.target.value })
                                        }} className='form-control' placeholder='id' required />
                                    </div>
                                </div> */}
