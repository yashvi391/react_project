...
import { RefreshCw, ChevronDown, Edit, Trash2, Eye } from "react-feather";
  ...
  const AddModal = () => {
    ...
    const onSubmit = (e) => {
      ...
      axios
        .post(
          new URL(
            "/api/v1/configuration/business-partner-group/create",
            themeConfig.backendUrl
          ),
          form
        )
  ...
  const EditModal = () => {
    ...
    const onSubmitEdit = (e) => {
      ...
      axios
        .put(
          new URL(
            "/api/v1/configuration/business-partner-group/update",
            themeConfig.backendUrl
          ),
          form
        )
