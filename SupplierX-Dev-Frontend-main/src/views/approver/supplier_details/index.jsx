...
const SupplierDetails = ({ stepper }) => {
  ...
  const updateList = () => {
    axios
      .post(
        new URL(
          "/api/v1/configuration/supplier/update_tds",
          themeConfig.backendUrl
        ),
        {
          id: id,
          tds_type: [selectedTax.value],
          tds_code: [selectedCode.value],
          tds_subject: "1",
          tds_receipent: [selectedRecepient.value],
        }
      )
      .then((res) => {
        if (res.data.error) {
  ...
  const getTds = () => {
    axios
      .post(new URL("/api/admin/tds/tax_types", themeConfig.backendUrl))
      .then((res) => {
  ...
  const getPayment = (data) => {
    axios
      .post(new URL("/api/admin/paymentTerms/list", themeConfig.backendUrl))
      .then((res) => {
  ...
  const sendStatus = (e) => {
    ...
    if (value) {
      axios
        .post(
          new URL(
            "/api/v1/configuration/supplier/changestatus",
            themeConfig.backendUrl
          ),
          sendData
        )
      ...
      {supplierData ? (
        <>
                            ...
                            <Row className="justify-content-between align-items-center">
                              ...
                              <Col md={4} className="mb-md-0 mb-1">
                                ...
                                <Select
                                  ...
                                  onChange={(e) => setSelectedRecepient(e)}
                                />
                              </Col>
                              <Col md={3} className="mb-md-0 mb-1">
                                <Label
                ...
                <div class="col-md-4 py-2">
                  ...
                  <div style={font600}>
                    <Input
                      ...
                      id="cinNoVertical"
                      value={supplierData ? supplierData.contactPersonName : ""}
                      placeholder="---"
                    />
                  </div>
                </div>
          ...
          >
            <CardHeader>
              <CardTitle>
                <h3 style={{ color: "#E06522" }}>Additional Details</h3>
              </CardTitle>
            </CardHeader>
              ...
              <Row>
                ...
                <Col className="mb-1 mt-1" md="4" sm="12">
                  ...
                  <Select
                    ...
                    isDisabled={addCompanyData.vendor_class_name}
                    required
                    formatGroupLabel={formatGroupLabel}
                    className="react-select"
                    classNamePrefix="select"
          ...
          >
            <CardHeader>
              <CardTitle>
                <h3 style={{ color: "#E06522" }}>Workflow Information</h3>
              </CardTitle>
            </CardHeader>
            <CardBody>
