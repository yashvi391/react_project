        ...
        <ModalBody className='pb-5 px-sm-0'>
          <div className='px-sm-4 mx-50'>
            ...
            <p className='text-center mb-5'>
              Invite your friend to SupplierX, if they sign up, you and
              <br />
            ...
            <Row tag='form' className='g-1' onSubmit={e => e.preventDefault()}>
              <Col lg='10'>
                <Label for='friendEmail' className='form-label'>
                  Enter your friend’s email address and invite them to join SupplierX 😍
                </Label>
            ...
            <Row tag='form' className='g-1' onSubmit={e => e.preventDefault()}>
              <Col lg='9'>
                ...
                <InputGroup className='input-group-merge'>
                  <Input type='url' id='referral-url' defaultValue='https://1.envato.market/SupplierX_admin' />
